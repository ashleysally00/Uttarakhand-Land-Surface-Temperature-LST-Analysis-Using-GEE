...
This repository contains a Google Earth Engine script for preprocessing Land Surface Temperature (LST) data for a machine learning project focused on wildfire prediction. LST data measures the radiometric temperature of the Earth's surface, which helps assess how thermal energy interacts with vegetation and soil - critical factors in determining wildfire risk To better predict how fires might behave in the future, we analyzed data from **January 2012 to June 30, 2024**, focusing on Uttarakhand (though you can modify the geographic region to suit your specific research needs).
