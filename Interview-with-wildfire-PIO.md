...
I interviewed a wildfire Public Information Officer/volunteer firefighter in Redding, California, to get background information on what types of data it would be most useful to collect when working on a Machine Learning wildfire prediction tool using AI, *subject: wildfire spread*
